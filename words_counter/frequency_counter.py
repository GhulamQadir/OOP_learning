class WordCounter:
    ...
    Attributes:
        ...
        __words_frequency (dict): Stores words as keys and their corresponding frequencies as values.
    ...
    def __init__(self, input_text):
        ...
        self.__input_text = self._validate_input(input_text)
    ...
    def _keys_list(self):
        ...
        self.__keys_list = list(self.__words_frequency.keys())

    # Dunder methods for dict-like behavior
    def __getitem__(self, key):
        """Allows dictionary-style access: wc['word'] → frequency."""
        return self.__words_frequency[key]

    def __contains__(self, key):
        """Allows `word in wc` syntax."""
        return key in self.__words_frequency

    def __len__(self):
        """Returns number of unique words."""
        return len(self.__words_frequency)
    ...
    def __next__(self):
        ...
        if self.__iter_index < len(self) - 1:
            ...
            return {key: self.__words_frequency[key]}
    ...
    def words_frequency(self):
        ...
        split_input_to_list = self.__input_text.split()
        ...
        for i, word in enumerate(split_input_to_list):
            ...
            if word in self.__words_frequency:
                continue
            ...
            self.__words_frequency[word] = occurrence_count
    ...
    def __str__(self):
        ...
        """
        return (
            f"String Input: {self.__input_text}\n"
            f"Occurences of words: {self.__words_frequency}"
        )
